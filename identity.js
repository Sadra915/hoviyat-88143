  ...
  unsubscribe = onSnapshot(doc(db, "users", uid), snap => {
    ...
    container.innerHTML = `
      <div class="idcard">
        ...
        <h2 class="idcard-name">${u.displayName || u.username}</h2>
        ...
        <div class="idcard-actions">
          <button id="idShareBtn" class="btn-primary">🔗 اشتراک‌گذاری لینک</button>
          <button id="idCopyBtn" class="btn-outline">کپی @یوزرنیم</button>
        </div>
      </div>
    `;
