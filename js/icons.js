...
const PATHS = {
  ...
  pin: `<path d="M12 17v5"/><path d="M9 10.76a2 2 0 0 1-1.11 1.79l-1.78.9A2 2 0 0 0 5 15.24V17a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-1.76a2 2 0 0 0-1.11-1.79l-1.78-.9A2 2 0 0 1 15 10.76V7a1 1 0 0 1 1-1 2 2 0 0 0 0-4H8a2 2 0 0 0 0 4 1 1 0 0 1 1 1z"/>`,
  phoneOff: `<path d="M10.7 5.3a1 1 0 0 1 1.4 0l1.4 1.4a1 1 0 0 1 0 1.4l-1.2 1.2a12.4 12.4 0 0 0 4.4 4.4l1.2-1.2a1 1 0 0 1 1.4 0l1.4 1.4a1 1 0 0 1 0 1.4l-1.6 1.6a2 2 0 0 1-2.1.5A18 18 0 0 1 4.9 6.2a2 2 0 0 1 .5-2.1z"/><line x1="2" y1="2" x2="22" y2="22"/>`,
  ...
  thumbsUp: `<path d="M7 10v10H4a2 2 0 0 1-2-2v-6a2 2 0 0 1 2-2h3Z"/><path d="M7 10 11 3a2 2 0 0 1 3.7 1.2L14 8h5.2a2 2 0 0 1 2 2.3l-1 7a2 2 0 0 1-2 1.7H7"/>`,
  laugh: `<circle cx="12" cy="12" r="10"/><path d="M7 13h10a5 5 0 0 1-10 0Z"/><path d="M8 9h.01M16 9h.01"/>`,
  surprise: `<circle cx="12" cy="12" r="10"/><circle cx="9" cy="9" r="1"/><circle cx="15" cy="9" r="1"/><circle cx="12" cy="15" r="2"/>`,
  frown: `<circle cx="12" cy="12" r="10"/><path d="M8 17s1.5-2 4-2 4 2 4 2"/><path d="M9 9h.01M15 9h.01"/>`,
  applause: `<path d="m7 11 3-7a2 2 0 0 1 3.7 1.4L12 10"/><path d="m12 10 2-4a2 2 0 1 1 3.7 1.4L16 11"/><path d="m16 11 1-2a2 2 0 1 1 3.6 1.7l-3.4 7.1a4 4 0 0 1-3.6 2.2H9a4 4 0 0 1-3.6-2.2L3 13.5a2 2 0 0 1 3.7-1.6L8 14"/>`,
